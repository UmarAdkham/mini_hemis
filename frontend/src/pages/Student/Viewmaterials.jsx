...
function Viewmaterials() {
    ...
    useEffect(() => {
        const getMaterials = async () => {
            ...
            try {
                const res = await axios.get(`http://localhost:4000/student/get-course-materials/${id}`, {
                    headers: {
                ...
                setError('Materiallarni olishda xatolik yuz berdi. Iltimos, qayta urinib ko\'ring.');
    ...
    return (
        <div>
            {materials?.length > 0 ? (
                ...
                <div className="text-center text-gray-500">Materiallar mavjud emas.</div>
            )}
        </div>
    );
}
