// Bu faylda barcha kerakli ikonlar uchun komponentlar
...
export function FileVideoIcon({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function FileSpreadsheetIcon({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function FileArchiveIcon({ className }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
